...
- **Show data examples** - When interacting with databases, APIs, queues, or external systems, always provide sample input/output data in a business-friendly format

## Simplified Shape Types (Non-Technical)
| Shape Name | When to Use | How to Write It | Example |
| ---------- | ----------- | --------------- | ------- |
| **Action** | Something the system does | `Action: {what happens}` | `Action: Save customer information` |
| **Decision** | When the system makes a choice | `Decision: {question}` | `Decision: Is user logged in?` |
| **Data Storage** | When information is saved/retrieved | `Data Storage: {what data}` | `Data Storage: Get user profile` |
| **External System** | Connecting to other services | `External System: {service name}` | `External System: Send email` |
| **Start** | Beginning of process | `Start: {process name}` | `Start: Order Creation` |
| **Stop** | End of process | `Stop: {process name}` | `Stop: Order Complete` |
...
- **Sample Output/Response**:
  ...
  Record ID: "CUST-12345" or "ORD-98765"
  Timestamp: "2024-01-15 10:30:45 AM"
  Confirmation: "Data stored in Customer Database"
  ```
...
- **Sample Output/Response**:
  ...
  Message ID: "MSG-45678"
  Delivery Status: "Queued → Sent → Delivered"
  Response Time: "250ms"
  External System Reply: "Email accepted for delivery"
  ```
  ```
  To: Payment Service
  Data:
...
```
📊 Data Example:
Information Sent to Payment System:
  Amount: $150.00
  Customer: John Doe
  Card Ending: ****1234
  
Response from Payment System:
  Status: Approved
  Confirmation #: PAY-2024-789
```
...
- **Sample Output/Response**:
  ...
  Customer ID: "CUST-2024-0156"
  Database: "Main Customer Database"
  ```
```
...
- **Sample Input Data**:
  ```
  Customer SSN: "XXX-XX-1234" (last 4 digits only)
  Loan Amount: "$25,000"
  Purpose: "Auto Loan"
  ```
- **Sample Output/Response**:
...
- **Sample Output/Response**:
  ...
  Position in Queue: "#45"
  Estimated Processing: "Within 2 hours"
  Tracking ID: "TRACK-9876543"
  ```
```
...
- **Sample Input Data**:
  ...
  Template: "Welcome_New_User_2024"
...
- **Sample Output/Response**:
  ...
  Message ID: "smtp-2024-01-15-msg-789"
  Delivered At: "10:45:30 AM EST"
  Opens Tracking: "Enabled"
  ```
```
...
- **Sample Input Data**:
  ...
  Customer: "Jane Smith"
  Items: ["Red Shirt (Size M)", "Blue Jeans (Size 32)"]
  Shipping Priority: "Standard (3-5 days)"
  Delivery Address: "123 Main St, Anytown, USA"
  ```
- **Sample Output/Response**:
  ```
  Queue Status: "Successfully Queued"
  Position: "#45 in queue"
  Estimated Processing: "Within 2 hours"
  Tracking Number: "Generated: TRK-789456123"
  ```
```
...
- **Sample Output/Response**:
  ...
  Transaction ID: "ch_3O8h4kL2faKE3C4J0"
  Authorization Code: "AUTH-789456"
  Processing Fee: "$3.20"
  Available in Account: "2-3 business days"
